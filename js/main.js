...
$(function () {
    $(".pullsid").click(function () {
        $(".side").css("right", "2%");
        $(".pullsid").css("opacity", "0%");
        $(".pushsid").css("opacity", "100%");
        $('.pushsid').addClass('pullsidd');
    });
});

$(function () {
    $(".pushsid").click(function () {
        $(".side").css("right", "-100%");
        $('.pushsid').removeClass('pullsidd');
        $(".pullsid").css("opacity", "100%");
        $(".pushsid").css("opacity", "0%");
    });
});
